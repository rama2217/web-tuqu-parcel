...
<div class="w-full max-w-md">
    ...
    <p class="text-center text-sm mb-3" style="color:#C9A96E">Buat akun baru</p>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            {{-- Nama --}}
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#2D4A3E">Nama Lengkap</label>
            ...
            {{-- No HP --}}
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#2D4A3E">
            ...
            {{-- Konfirmasi Password --}}
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#2D4A3E">Konfirmasi Password</label>
                <div class="relative">
